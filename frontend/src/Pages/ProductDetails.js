...
const productImageListLoading = new Array(4).fill(0);
    ...
    <div className='contianer mx-auto p-4'>
        ...
        <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
            ...
            <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
                <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2'>
                    ...
                    {/**product zoom */}
                    {
                        ...
                        <div
                         className='h-full w-115% min-h-[400px] min-w-[486px] bg-slate-200 mix-blend-multiply scale-140' 
                         style={{
            ...
            {/***product details */}
            {
                ...
                <p className='bg-slate-200 animate-pulse  px-2 rounded-full inline-block w-fit'>{data.brandName}</p>
                ...
                <div className='flex items-cemter gap-3 my-2'>
                    <button className='border-2 border-red-600 rounded px-3 py-1 min-w-[100px] text-red-600 hover:bg-red-600 hover:text-white' onClick={(e)=>handleBuyProduct(e, data?._id)}>Buy </button>
        ...
        {
            data.category && (
                <CategoryWiseProductDisplay category={data.category} heading={"Recommended Books"} />
            )
        }
